...
import com.backend.book_network.model.BusinessErrorCodes;
...
import static com.backend.book_network.model.BusinessErrorCodes.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleException(Exception exception) {
        ...
        return ResponseEntity
                ...
                .body(
                        ExceptionResponse.builder()
                                .businessErrorCode(Integer.valueOf("Internal error, contact the admin!"))
